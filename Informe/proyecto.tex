...
%
\input{capitulos/02_Estimacion_y_Presupuesto}
%
\input{capitulos/03_Repaso_Bibliografico}
%
\part{Parte matemática}
\input{capitulos/04_Contexto_Matematico}
%
\input{capitulos/05_Problema_Diseño_Experimental}
%
\part{Parte informática}
\input{capitulos/06_Algoritmos_Referencia}
%
\input{capitulos/07_Componentes_Propuesta}
%
\input{capitulos/08_Parte_Experimental}
%
