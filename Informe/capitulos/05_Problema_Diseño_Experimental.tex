...
En definitiva, podemos resumir los parámetros, para lo que se usan y sus valores en la siguiente tabla:
...
\rowcolor[HTML]{DDFDFF} 
\texttt{EvaluacionMAX}    & \begin{tabular}[c]{@{}l@{}}Criterio de parada: Número de\\ Evaluaciones Máximas dicho\\ algoritmo\end{tabular}                            & \texttt{NEEVALUACIONESMAX}                                           \\ \hline
\rowcolor[HTML]{DAE8FC} 
