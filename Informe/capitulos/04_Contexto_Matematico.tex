...
%Distinción entre test paramétricos (t-student y ANOVA) y no paramétricos (Wilcoxon y post hoc), que aunque los primeros son los más usados exigen una serie de condiciones (indicar cuales) que ya se ha demostrado en ciertos benchmarks no se puede suele cumplir (incluir referencia de Molina sobre ello), por eso aplicaremos los segundos
